...
const checkOneMonthResetTokenComsumption = async (ws: ServerWebSocket, userId: string) => {
...
const verifyWebSocketUser = async (ws: ServerWebSocket, tenant: string, token: string) => {
    try {
